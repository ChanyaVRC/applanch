...
{
    private static readonly IReadOnlyDictionary<ThemeBrushKey, ThemeColor> EmptyColors = new Dictionary<ThemeBrushKey, ThemeColor>();
    ...
    internal override IReadOnlyDictionary<ThemeBrushKey, ThemeColor> ColorsByKey => EmptyColors;
