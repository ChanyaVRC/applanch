...
5. Both distribution formats include `applanch.ThemeCreator.exe` for theme authoring.
...
- Both packages include the Theme Creator tool (`applanch.ThemeCreator.exe`) in the same folder as the main app.
